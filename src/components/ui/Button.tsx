...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    ...
    secondary: 'bg-global-12 text-global-8 hover:bg-global-10 active:bg-global-7 focus:ring-global-7',
    outline: 'border border-global-7 text-global-8 bg-transparent hover:bg-global-10 active:bg-global-7 focus:ring-global-7',
